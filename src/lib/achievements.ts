...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: "roadmap-complete", zh: "完成融资路线图", en: "Fundraising Roadmap Complete", icon: "🗺️", unlockedBy: "capital-roadmap", tier: "silver" },
  { id: "spv-builder", zh: "建立第一个SPV", en: "First SPV Built", icon: "🏗️", unlockedBy: "spv-structure", tier: "gold" },
  ...
  { id: "data-room", zh: "数据室已建立", en: "Data Room Established", icon: "🗂️", unlockedBy: "data-room", tier: "silver" },
  { id: "risk-controller", zh: "风控系统激活", en: "Risk Control Active", icon: "🛡️", unlockedBy: "risk-control", tier: "gold" },
  ...
  { id: "breakeven", zh: "损益平衡点已知", en: "Break-even Point Known", icon: "⚖️", unlockedBy: "breakeven-analysis", tier: "bronze" },
];
