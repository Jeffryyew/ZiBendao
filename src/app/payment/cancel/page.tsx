...
export default async function PaymentCancelPage() {
  ...
  return (
    ...
    >
      ...
      >
        {isEn ? "Payment Cancelled" : "付款已取消"}
      </h1>
      <p className="text-base mb-2" style={{ color: "#68625C" }}>
        {isEn ? "Your payment was cancelled and no charges were made." : "您的付款已被取消，账户未产生任何费用。"}
      </p>
      <p className="text-sm mb-10" style={{ color: "#9A9490" }}>
        {isEn ? "If you have any questions, feel free to contact our advisory team." : "如有疑问，欢迎联系我们的顾问团队。"}
      </p>
