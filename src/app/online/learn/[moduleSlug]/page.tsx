  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "var(--color-bg-primary)" }}>
      ...
      <div
        ...
        style={{ backgroundColor: "#FFFFFF", border: `1px solid ${color}30` }}
      >
        <div
      ...
      <div className="px-4 mt-6 pb-28">
        <h2 className="text-xs font-semibold mb-4 uppercase tracking-widest" style={{ color: "var(--color-text-muted)" }}>
          课程关卡
        </h2>
            ...
            const row = (
              <div
                ...
                style={{
                  ...
                  border: isNext ? `1px solid ${color}30` : "1px solid #E0D9CE",
              ...
              >
                ...
                <div className="text-xs font-mono flex-shrink-0" style={{ color: isDone ? color : "var(--color-text-muted)" }}>
                  +{lesson.xpReward}XP
                </div>
              </div>
            );
      ...
      >
        <Link
          ...
          style={{ background: `linear-gradient(135deg, ${color} 0%, ${color}cc 100%)`, color: "#FFFFFF" }}
        >
