...
function IndicatorCard({
  ...
  return (
    <div className="rounded-2xl p-5" style={{ backgroundColor: c.bg, border: `1px solid ${c.border}` }}>
      ...
      <p className="text-xs leading-relaxed mb-1" style={{ color: "#555550" }}>{hint}</p>
...
export default function BalanceSheetTool({ locale }: { locale: "zh" | "en" }) {
  ...
  const sym = "RM"; // T02 uses RM by default; FinancialCore will carry currency later
    ...
    >
      <div className="space-y-5">
        ...
        <div className="grid lg:grid-cols-2 gap-5">
          ...
          <Card>
            <Label>资产</Label>
            <p className="text-xs font-semibold mb-2" style={{ color: "#444440" }}>流动资产</p>
            ...
            <p className="text-xs font-semibold mt-4 mb-2" style={{ color: "#444440" }}>固定资产</p>
          ...
          <Card>
            <Label>负债 + 权益</Label>
            <p className="text-xs font-semibold mb-2" style={{ color: "#444440" }}>短期负债</p>
            ...
            <p className="text-xs font-semibold mt-4 mb-2" style={{ color: "#444440" }}>长期负债</p>
            ...
            <p className="text-xs font-semibold mt-4 mb-2" style={{ color: "#444440" }}>股东权益</p>
        ...
        <Card accent>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="rounded-2xl p-5"
              style={{
                backgroundColor: roeSignal() === "neutral" ? "#141414" : roeSignal() === "green" ? "rgba(34,197,94,0.05)" : roeSignal() === "yellow" ? "rgba(240,164,69,0.05)" : "rgba(239,68,68,0.05)",
                border: `1px solid ${roeSignal() === "neutral" ? "#2A2A2A" : roeSignal() === "green" ? "rgba(34,197,94,0.2)" : roeSignal() === "yellow" ? "rgba(240,164,69,0.2)" : "rgba(239,68,68,0.2)"}`,
              }}
            >
              <div className="flex items-start justify-between mb-2">
                <span className="text-xs font-semibold" style={{ color: "#A0A09A" }}>ROE（净资产回报率）</span>
              ...
              <p className="text-xs mb-1" style={{ color: "#555550" }}>净利润 ÷ 净资产</p>
              {calc.roe !== null ? (
                ...
                <div className="space-y-1.5">
                  <p className="text-xs" style={{ color: "#444440" }}>请先完成利润表，或手动输入：</p>
                  <div className="relative">
                    <input
                      ...
                      style={{ backgroundColor: "#0D0D0D", border: "1px solid #2A2A2A", color: "#F5F5F0" }}
                    />
                    <span className="absolute left-2 top-1/2 -translate-y-1/2 text-xs font-mono pointer-events-none" style={{ color: "#555550" }}>RM</span>
                  </div>
                </div>
              )}
            </div>
        ...
        >
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-xs leading-relaxed" style={{ color: "#888880" }}>
