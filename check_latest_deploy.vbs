...
Set f = fso.CreateTextFile("C:\Users\Dell\Desktop\zibendao\latest_deploy.txt", True, False)
f.WriteLine "Status: " & http.Status
f.WriteLine "Body: " & Left(http.responseText, 3000)
f.Close

MsgBox "Done! Check latest_deploy.txt"
