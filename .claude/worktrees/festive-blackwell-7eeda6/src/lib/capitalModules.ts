...
export const CAPITAL_MODULES: CapitalModule[] = [
  ...
  {
    id: "working-capital", icon: "⚙️", layer: 1, href: "/tools/working-capital",
  ...
  {
    id: "data-room", icon: "🗄️", layer: 2, href: "/tools/data-room",
  ...
  {
    id: "competitive-analysis", icon: "⚔️", layer: 2, href: "/tools/competitive-analysis",
  ...
  {
    id: "spv-structure", icon: "🏗️", layer: 3, href: "/tools/spv-structure",
  ...
  {
    id: "capital-structure", icon: "🏛️", layer: 3, href: "/tools/capital-structure",
  ...
  {
    id: "risk-control", icon: "🛡️", layer: 3, href: "/tools/risk-control",
